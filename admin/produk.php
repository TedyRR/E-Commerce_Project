<?php
  ...
  if(isset($_POST["hapus"])){
    if(hapus($_POST["id"])){
      header('location:produk.php?deleted=true');
    }
  }
?>
            ...
            <div class="card w-100">
              <div class="card-body p-4">
                <div class="d-flex justify-content-between mb-3">
                  ...
                  <a href="produkTambah.php" class="btn btn-success">
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1"><?= $item["kode"] ?></h6>                        
                        </td>
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1"><?= $item["nama"] ?></h6>                        
                        </td>
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">Rp. <?= number_format($item["harga_jual"], 0, ",", ".") ?></h6>
                        </td>
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1"><?= $item["stok"] ?></h6>                        
                        </td>
                        <td class="border-bottom-0 d-flex justify-content-around">
                          <a href="produkDetail.php?id=<?= $item["id"]; ?>" class="btn btn-warning btn-sm">
                            <i class="ti ti-eye"></i> Detail
                          </a>
                          <a href="produkEdit.php?id=<?= $item["id"]; ?>" class="btn btn-primary btn-sm">
