        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="alert alert-success">
              <h6 class="mb-0 text-success">Tambah produk berhasil.</h6>
            </div>
            <?php endif ?>
          </div>
              ...
              <div class="card-body p-4">
                ...
                <form action="" method="POST">
                  ...
                  <div class="mb-3 w-50">
                    ...
                    <input type="text" class="form-control" id="inputKode" name="kode" placeholder="cth. A0001" required>
                  </div>
                  <div class="mb-3 w-50">
                    <label for="inputNama" class="form-label">Nama</label>
                    <input type="text" class="form-control" id="inputNama" name="nama" placeholder="cth. Macbook Pro M2" required>
                  </div>
                  <div class="mb-3 w-50">
                    <label for="inputHargaJual" class="form-label">Harga Jual (Rp)</label>
                    <input type="number" class="form-control" id="inputHargaJual" name="harga_jual" required>
                  </div>
                  <div class="mb-3 w-50">
                    <label for="inputHargaBeli" class="form-label">Harga Beli (Rp)</label>
                    <input type="number" class="form-control" id="inputHargaBeli" name="harga_beli" required>
                  </div>
                  <div class="mb-3 w-50">
                    <label for="inputStok" class="form-label">Stok</label>
                    <input type="number" class="form-control" id="inputStok" name="stok" required>
                  </div>
                  <div class="mb-3 w-50">
                    <label for="inputMinStok" class="form-label">Min Stok</label>
                    <input type="number" class="form-control" id="inputMinStok" name="min_stok" required>
                  </div>
                  <div class="mb-3 w-50">
                    <label for="inputDeskripsi" class="form-label">Deskripsi</label>
                    <textarea class="form-control" id="inputDeskripsi" name="deskripsi" required>
                    </textarea>
                  </div>
