        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="alert alert-success">
              <h6 class="mb-0 text-success">Tambah kategori berhasil.</h6>
            </div>
            <?php endif ?>
          </div>
            ...
            <div class="card w-100">
              <div class="card-body p-4">
                <div class="d-flex justify-content-between mb-3">
                  <h5 class="card-title fw-semibold">Tambah Kategori Produk</h5>
                </div>
                <form action="" method="POST">
                  <div class="mb-3 w-50">
                    <label for="inputNama" class="form-label">Nama</label>
                    <input type="text" class="form-control" id="inputNama" name="nama" placeholder="cth. Elektronik" required>
                  </div>
